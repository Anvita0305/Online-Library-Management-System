...
const NewBooks = () => {
  ...
  const fetchData = (e) => {
    axios
      .get("http://localhost:8000/addbook")
      .then((res) => {
      ...
      <div className="container">
        <div className="booksmenu" style={{backgroundColor:"white"}}>
          <ul>
            ...
            <li style={{ margin: "1.5rem" }}>Damaged Books</li>
            <li style={{ margin: "1.5rem" }}><Link to={"/LostBooks"}>Lost Books</Link></li>
            <li style={{ margin: "1.5rem" }}><Link to={"/ReplaceBooks"}>Books to be Replaced</Link></li>
          </ul>
        </div>
        <br />
